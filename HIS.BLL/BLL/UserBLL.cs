...
namespace HIS.BLL
{
    public class UserBll : IUserBll
    {
        ...
        {
            return UserDal.UpdateUserProfile(user);
        }

       public bool NewUpdateUserProfile (User user) ////// my Editing
        {
            return UserDal.UpdateUserProfile(user);
        }
        ...
        {
            return UserDal.GetDataForUserProfile(id);
        }
    ...
    public interface IUserBll
    {
        ...
        //bool NewUpdateUserProfile(User user);
